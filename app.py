...
def predict():
    ...
    prediction = model.predict(features)[0]  # features Must be in the form [[a, b]]

    # Convert prediction value to the desired string format
    if prediction == 1:
        result_string = "Yes, the person is diabetic"
    else:
        result_string = "No, the person is not diabetic"
